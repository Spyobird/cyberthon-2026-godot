...
const HINT_MESSAGES = [
	"HOW TO USE P.A.W.S. (PROXMARK ARCANE WIRELESS SENTINEL)",
	"Initialize the Arcane Terminal by typing [bgcolor=black][color=web_green][code]pm3[/code][/color][/bgcolor] to bridge the connection.",
